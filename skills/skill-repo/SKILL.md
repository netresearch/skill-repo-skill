...
This skill defines how a *skill* repository is structured. Two related skills cover adjacent concerns:

- **`agent-rules-skill`** — generates AGENTS.md content. Every skill repo created with this skill should have its AGENTS.md generated by `agent-rules-skill`.
- **`agent-harness-skill`** — verifies and bootstraps the broader agent-readiness harness (CI verification, enforcement mechanisms, `docs/` structure). Skill repos benefit from harness verification too.
